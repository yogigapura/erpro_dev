                ...
                <div class="form-group">
                    ...
                    <select class="form-select" name="id_group" id="id_group" required>
                        @foreach ($groups as $group)
                            <option value="$group" @selected(old('group') == $group) >{{$group->group_name}}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <select class="form-select" name="id_cust" id="id_cust" required>
                        @foreach ($customers as $customer)
                            <option value={{$customer->id_cust}} @selected(old('customer') == $customer) >{{$customer->cust_name}}</option>
                        @endforeach
                </select>
            </div>
